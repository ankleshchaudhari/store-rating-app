...
import { Store, LogOut, User, Menu, Home, Settings } from "lucide-react"
    ...
    <div className="flex min-h-screen flex-col">
      <header className="bg-white border-b h-16 flex items-center justify-between px-6">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <Link href="/user/dashboard" className="text-gray-700 hover:text-gray-900">
            Stores
          </Link>
          <Link href="/user/settings" className="text-gray-700 hover:text-gray-900">
            Settings
          </Link>
        </div>
